...
import com.example.fable.DataDummy
import com.example.fable.MainDispatcherRule
import com.example.fable.data.StoryRepository
import com.example.fable.data.local.entity.Story
import com.example.fable.getOrAwaitValue
...
class HomeViewModelTest {
    ...
    fun `when Get Stories Should Not Null and Return Data`() = runTest {
        ...
        val actualStories: PagingData<Story> = homeViewModel.getAllStories().getOrAwaitValue()
